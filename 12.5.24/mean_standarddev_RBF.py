...
#first reshape into an array that NUMPY can understadn
...
for n in range (1): #we can change the range value here to incoporate curves 0 to n-1, in this case n=3
